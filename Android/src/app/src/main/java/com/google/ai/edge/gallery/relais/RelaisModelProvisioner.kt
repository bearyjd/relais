 ...
 *
 * Note: unlike Gallery's [com.google.ai.edge.gallery.data.DefaultDownloadRepository], this does not
...
object RelaisModelProvisioner {
   ...
   * [com.google.ai.edge.gallery.data.DefaultDownloadRepository.downloadModel] (same unique-work key
