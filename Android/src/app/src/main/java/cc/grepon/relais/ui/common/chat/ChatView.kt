...
package cc.grepon.relais.ui.common.chat

// import cc.grepon.relais.ui.preview.PreviewChatModel
// import cc.grepon.relais.ui.preview.PreviewModelManagerViewModel
// import cc.grepon.relais.ui.preview.TASK_TEST1
...
import cc.grepon.relais.ui.common.ModelPageAppBar
import cc.grepon.relais.ui.common.copyBitmapToClipboard
import cc.grepon.relais.ui.common.saveBitmapToMediaStore
import cc.grepon.relais.ui.common.shareBitmap
...
/**
 * Deserializes a list of [cc.grepon.relais.proto.ChatMessageProto] from persistent
...
private fun deserializeProtoMessages(
  protoMessages: List<cc.grepon.relais.proto.ChatMessageProto>
): List<ChatMessage> {
  return protoMessages.mapNotNull { protoMsg ->
    val side =
      when (protoMsg.side) {
        cc.grepon.relais.proto.ChatSideProto.CHAT_SIDE_USER -> ChatSide.USER
        cc.grepon.relais.proto.ChatSideProto.CHAT_SIDE_MODEL -> ChatSide.AGENT
        cc.grepon.relais.proto.ChatSideProto.CHAT_SIDE_SYSTEM -> ChatSide.SYSTEM
